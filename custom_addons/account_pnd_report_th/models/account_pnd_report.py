...
class AccountPNDReport(models.TransientModel):
    ...
    def _flatten_pdf_with_thai_font(self, data_dict):
        ...
        c.drawString(335, 218, data_dict.get('date14_0', ''))
        c.drawRightString(488, 218, data_dict.get('pay1_13', ''))
        c.drawRightString(560, 218, data_dict.get('tax1_13', ''))

        # checkbox ตัวอย่าง
        c.drawString(475, 605, f"chk4: {data_dict.get('chk4', '')}")
        c.drawString(398, 582, f"chk7: {data_dict.get('chk7', '')}")
