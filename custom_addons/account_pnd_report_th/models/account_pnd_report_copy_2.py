...
class AccountPNDReport(models.TransientModel):
    ...
    def generate_move_document_numbers(self, moves):
        ...
        for move in moves:
            ...
            month_str = move.date.strftime('%Y%m') if move.date else '000000'  # yyMM
    ...
    def _flatten_pdf_with_thai_font(self, data_dict):
        ...
        c.drawRightString(560, 219, data_dict.get('tax1_13', ''))
        ...
        c.drawString(520, 768, f"{data_dict.get('doc_number', '')}")
    ...
    # ----------------------------
    def _prepare_data_dict(self, pnd_type, partner, move, doc_number):
