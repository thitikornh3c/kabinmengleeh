...
class PND53ExportWizard(models.TransientModel):
    _name = 'pnd53.export.wizard'
    _description = 'PND 53 Date Range Export Wizard'
    ...
    def action_confirm_export_pnd53(self):
        ...
        try:
            ...
            _logger.error("PND 53 API Error: Status %s, Detail: %s", status, str(e))
            ...
            _logger.error("PND 53 Internal Error: %s", str(e))
